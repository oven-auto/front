<template>
<div class="">
    <div class="container-fluid back-testdrive" v-if="!loading && finding" >
        <div class="container ">
        <div class="row ">
            <div class="col-7">
                ...
                <div class="col-12">
                    <div class="row testdrive-form">

                        <div class="col-6 p-0" v-for="item in text" :key="'testdrive-form'+item.id">
...
export default {
    ...
    methods: {
        loadData() {
            this.loading = true
            this.finding = true
            axios.get(apiDomen + '/api/front/forms/get?brand_id='+BRAND_ID+'&form_event=test')
            .then(res=>{
                if(res.data.status)
